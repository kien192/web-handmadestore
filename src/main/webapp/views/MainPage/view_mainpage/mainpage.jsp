...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
   ...
   <%User u = (User) session.getAttribute("auth");%>
    <% List<Category> dataC = (List<Category>) request.getAttribute("dataC");
    if(dataC == null) dataC = new ArrayList<>();%>
    <% List<Tip> dataTip = (List<Tip>) request.getAttribute("dataTip");
    if(dataTip == null) dataTip = new ArrayList<>();%>
<html>
...
<%--                <a href="#"><img src="<%=t.getImgPath()%>" width="100%"></a>--%>
<%--                <a href="#"><h6 class="fw-bold text-center mt-3"><%=t.getTitle()%></h6></a>--%>
<%--                <p><%=t.getDescription()%>--%>
<%--                </p>--%>
<%--            </li>--%>
