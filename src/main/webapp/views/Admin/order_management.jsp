        ...
        <div class="mytables">
            <table class="m-auto" id="mytable">
                ...
                <tr class="table_order text-center sticky-top">
                    <th class="col-3 px-5 py-3">Mã Đơn Hàng</th>
                    <th class="col-3 px-5 py-3">ID Khách Hàng</th>
                    <th class="col-4">Tên Khách Hàng</th>
                    <th class="col-4">Địa Chỉ Giao</th>
                    <th class="col-4">Ngày Đặt Hàng</th>
                    <th class="col-4">Tổng Tiền Hóa Đơn</th>
                    <th class="col-4">Phí Vận Chuyển</th>
                    <th class="col-3">Tổng Hóa Đơn</th>
                    <th class="col-3">Trạng Thái</th>
                    <th class="col-4">Chi Tiết Hóa Đơn</th>
                </tr>
                </thead>
                <tbody>
